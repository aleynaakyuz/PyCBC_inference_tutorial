...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "local", "url": "file:///home/aakyuz/tutorial/workflow_outputs/local-site-scratch/work/./CE40-INJECTION_17-0-10.HDFDEMARG-0-10.hdf", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "condorpool_symlink", "url": "symlink://$PWD/CE40-INJECTION_17-0-10.HDFDEMARG-0-10.hdf" }
   ] }
]
eof
...
[
 { "type": "transfer",
   "linkage": "output",
   "lfn": "CE40-INJECTION_17-0-10.HDFDEMARG-0-10.png",
   "id": 1,
   "src_urls": [
     { "site_label": "condorpool_symlink", "url": "file://$PWD/CE40-INJECTION_17-0-10.HDFDEMARG-0-10.png", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "local", "url": "file:///home/aakyuz/tutorial/workflow_outputs/local-site-scratch/work/./CE40-INJECTION_17-0-10.HDFDEMARG-0-10.png" }
   ] }
]
eof
